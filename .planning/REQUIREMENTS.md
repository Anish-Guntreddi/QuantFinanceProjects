...
- [ ] **MCR-01**: Macro data layer loads FRED series via fredapi when an API key is present, and falls back to a deterministic synthetic macro generator (default path; used by all tests)
