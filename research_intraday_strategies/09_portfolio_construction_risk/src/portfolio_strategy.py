...
class StrategyConfig:
    """Configuration for portfolio_construction_risk strategy."""
...
class PortfolioConstructionRiskStrategy:
    """Implementation of Portfolio optimization with risk management."""
